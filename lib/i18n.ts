...
const en = {
  ...
  link: {
    ...
    findSubtitle: "It has to be the exact name you appear with on the leaderboard.",
...
const es: Dictionary = {
  ...
  link: {
    ...
    findSubtitle: "Tiene que ser el nombre exacto con el que apareces en el leaderboard.",
