...
const en = {
  ...
  overlay: {
    ...
    sizeNote: "Each row adds 36 px, so ?rows=7 means 340 × 262. Spare height stays transparent; too little and OBS crops the last row.",
    pinnedWarning:
  ...
  link: {
    ...
    allianceHelp: "Alliances aren't published in the official leaderboard, so we keep the list by hand.",
    allianceNone: "No alliance",
    allianceLoading: "Loading alliances…",
    allianceLoadFailed: "We couldn't load the alliance list. Reload the page to try again.",
    allianceMissing: "My alliance isn't on the list",
    allianceRequestHelp:
      "We add it once someone checks it, so it isn't published straight away. Meanwhile you can send this form without an alliance and add it later with your code.",
    allianceContactPlaceholder: "Discord or email, so we can reply",
    allianceRequestSend: "Request it",
    allianceRequestSending: "Sending…",
    allianceRequestCancel: "Cancel",
    allianceRequested:
...
const es: Dictionary = {
  ...
  overlay: {
    ...
    sizeNote: "Cada fila suma 36 px, así que con ?rows=7 son 340 × 262. El alto que sobra queda transparente; si falta, OBS recorta la última fila.",
    pinnedWarning:
  ...
  link: {
    ...
    allianceHelp: "Las alianzas no se publican en el leaderboard oficial, así que la lista la mantenemos a mano.",
    allianceNone: "Sin alianza",
    allianceLoading: "Cargando alianzas…",
    allianceLoadFailed: "No pudimos cargar la lista de alianzas. Recarga la página para reintentar.",
    allianceMissing: "Mi alianza no está en la lista",
    allianceRequestHelp:
      "La agregamos cuando alguien la revise, así que no se publica al instante. Mientras tanto puedes enviar este formulario sin alianza y agregarla después con tu código.",
    allianceContactPlaceholder: "Discord o email, para poder responderte",
    allianceRequestSend: "Pedirla",
    allianceRequestSending: "Enviando…",
    allianceRequestCancel: "Cancelar",
    allianceRequested:
