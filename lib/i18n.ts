...
const en = {
  ...
  link: {
    ...
    intro:
      "You prove the account is yours by putting a code in your in-game profile name. Nobody else can change it, so that's enough. We never ask for a password or access to anything.",
    step1: "Find your account",
    step2: "Paste the code",
    step3: "Add your links",
    findTitle: "What's your in-game name?",
    findSubtitle:
      "It has to be the exact name you appear with on the leaderboard.",
    findPlaceholder: "Your profile name",
    findButton: "Find me",
    foundPrefix: "We found",
    foundSuffix: "on the ladder",
    change: "Change",
    alreadyVerified:
      "This account was already verified. Continuing updates the linked channels.",
    ambiguousWarning:
      "More than one player shares this name in the ladder. The code still tells you apart, but your row may show without links until we gather some history.",
    ...
    mustTrim: "The game allows {max} characters, so you need to trim {n} from your current name.",
    socialsTitle: "Add your links",
    socialsSubtitle: "At least one. Each channel can be claimed by one account only.",
    twitch: "TWITCH",
    youtube: "YOUTUBE",
    untapped: "UNTAPPED",
    allianceLabel: "ALLIANCE TAG",
    alliancePlaceholder: "e.g. JOB",
    allianceHelp: "Optional. We can't read it from the official API, so it's up to you.",
    handlePlaceholder: "yourhandle",
    untappedPlaceholder: "Your profile link",
    needOne: "Add at least one channel.",
    cacheNote:
    ...
    successTitle: "Done — {name} is verified",
    successBody:
      "You can go back to your usual name in the game. Your links show next to your row, and from now on we store your history for the chart.",
    successCta: "See my profile",
    whyTitle: "Why this proves it's you",
    why1:
      "Your profile name appears on the live public leaderboard. If the code shows up there, you have access to the account — nobody else can change it.",
    why2:
      "We also check that the remaining name matches the one you claimed, so nobody can paste your code into their own account.",
    ...
    afterTitle: "After verifying",
    after1: "Go back to your usual name whenever you want.",
    after2: "Your links appear next to your row in the table.",
    after3: "We start storing your history for the chart.",
    topOnly:
      "Only accounts in the top 1 000 of the ladder can be linked, which is the most the official API returns.",
  },
  how: {
    title: "How it works",
    intro:
    ...
    s6a: "Your in-game name, the links and alliance tag you entered, and your history of rank and Snap Points. Nothing else. We never ask for a password, an email, or access to your Twitch or YouTube account.",
    s6b: "Verification works because only you can change your profile name inside the game.",
...
const es: Dictionary = {
  ...
  link: {
    ...
    intro:
      "Demuestras que la cuenta es tuya poniendo un código en tu nombre de perfil dentro del juego. Nadie más puede cambiarlo, así que con eso basta. Nunca pedimos contraseña ni acceso a nada.",
    step1: "Busca tu cuenta",
    step2: "Pega el código",
    step3: "Suma tus links",
    findTitle: "¿Cómo te llamas en el juego?",
    findSubtitle:
      "Tiene que ser el nombre exacto con el que apareces en el leaderboard.",
    findPlaceholder: "Tu nombre de perfil",
    findButton: "Buscarme",
    foundPrefix: "Encontramos a",
    foundSuffix: "en el ladder",
    change: "Cambiar",
    alreadyVerified:
      "Esta cuenta ya estaba verificada. Si continúas, actualizas los canales vinculados.",
    ambiguousWarning:
      "Hay más de un jugador con este nombre en el ladder. El código igual te distingue, pero tu fila puede aparecer sin links hasta que juntemos algo de historial.",
    renameTitle: "Cambia tu nombre en Marvel Snap",
    renameSubtitle:
      "Deja parte de tu nombre real: lo usamos para confirmar que eres tú.",
    ...
    mustTrim: "El juego permite {max} caracteres, así que tienes que recortar {n} de tu nombre actual.",
    socialsTitle: "Suma tus links",
    socialsSubtitle:
      "Al menos uno. Cada canal lo puede reclamar una sola cuenta.",
    twitch: "TWITCH",
    youtube: "YOUTUBE",
    untapped: "UNTAPPED",
    ...
    allianceHelp:
      "Opcional. No podemos leerlo de la API oficial, así que depende de ti.",
    handlePlaceholder: "tuhandle",
    untappedPlaceholder: "Link de tu perfil",
    needOne: "Suma al menos un canal.",
    cacheNote:
    ...
    successTitle: "Listo — {name} quedó verificado",
    successBody:
      "Ya puedes volver a tu nombre de siempre en el juego. Tus links aparecen junto a tu fila, y desde ahora guardamos tu historial para la gráfica.",
    successCta: "Ver mi perfil",
    whyTitle: "Por qué esto prueba que eres tú",
    why1:
      "Tu nombre de perfil aparece en el leaderboard público en vivo. Si el código aparece ahí, es porque tienes acceso a la cuenta — nadie más puede cambiarlo.",
    why2:
      "También verificamos que el nombre restante coincida con el que reclamaste, así nadie puede pegar tu código en su propia cuenta.",
    limitTitle: "El límite de 20 caracteres",
    limitBody:
      "El juego corta los nombres en 20 caracteres. Si el tuyo ya está al tope, te decimos exactamente cuántos recortar para que el código entre — y armamos el nombre sugerido por ti.",
    afterTitle: "Después de verificar",
    after1: "Vuelve a tu nombre de siempre cuando quieras.",
    after2: "Tus links aparecen junto a tu fila en la tabla.",
    after3: "Empezamos a guardar tu historial para la gráfica.",
    topOnly:
      "Solo se pueden vincular cuentas que estén en el top 1 000 del ladder, que es lo máximo que devuelve la API oficial.",
  },
  how: {
    title: "Cómo funciona",
    intro:
    ...
    s6a: "Tu nombre en el juego, los links y el tag de alianza que hayas escrito, y tu historial de puesto y Snap Points. Nada más. Nunca pedimos contraseña, ni correo, ni acceso a tu cuenta de Twitch o YouTube.",
    s6b: "La verificación funciona porque solo tú puedes cambiar tu nombre de perfil dentro del juego.",
